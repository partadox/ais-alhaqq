...
class Modelprogrambayar extends Model
{
    ...
    protected $allowedFields = ['kelas_id', 'bayar_peserta_id','status_bayar', 'status_konfirmasi', 'awal_bayar', 'awal_bayar_daftar', 'awal_bayar_infaq', 'awal_bayar_spp1', 'awal_bayar_spp2', 'awal_bayar_spp3', 'awal_bayar_spp4', 'nominal_bayar','bukti_bayar', 'keterangan_bayar', 'keterangan_bayar_tolak','tgl_bayar', 'waktu_bayar', 'tgl_bayar_konfirmasi', 'waktu_bayar_konfirmasi', 'validator'];
