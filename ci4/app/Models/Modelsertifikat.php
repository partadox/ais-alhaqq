...
class Modelsertifikat extends Model
{
    ...
    protected $allowedFields = ['sertifikat_peserta_kelas_id', 'nomor_sertifikat', 'periode_cetak','jenis_sertifikat', 'nominal_bayar_cetak', 'status_cetak', 'link_cetak', 'bukti_bayar_cetak', 'keterangan_cetak'];
