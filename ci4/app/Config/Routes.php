...
$routes->get('/auth/pembayaran/admin_rekap_bayar/rekap_spp_peserta/(:num)/(:num)', 'Pembayaran::rekap_spp_peserta/$1/$1', ['filter' => 'Validasilogin']);
...
$routes->get('/akademik/rekap_absen_peserta_export/', 'Akademik::admin_rekap_absen_peserta_export', ['filter' => 'Validasilogin']);
$routes->get('/akademik/rekap_absen_peserta_export/(:num)', 'Akademik::admin_rekap_absen_peserta_export', ['filter' => 'Validasilogin']);
