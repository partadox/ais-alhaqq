    ...
    public function import_file()
    {
        ...
        if (!$valid) {
            ...
            foreach ($sheet as $x => $excel) {
                ...
                //Cek Duplikat User
                $duplikat_user  = $this->pengajar->cek_duplikat_user($excel['1']);

                if ($nik != 0 || $user != 1 || $duplikat_user != 0) {
                    $jumlaherror++;
                    ...
                    $log = [
                        ...
                        'waktu_log'    => date("H:i:s"),
                        'status_log'   => 'GAGAL',
                        'aktivitas_log'=> 'Buat Data Pengajar via Import Excel, Nama Pengajar : ' .  $excel['5'] . $gagal1 . $gagal2 . $gagal3,
                    ];
                    $this->log->insert($log);
                    //Data Log END
                } elseif($nik == 0 && $user == 1 && $duplikat_user == 0) {
    ...
    public function edit_multiple()
    {
        ...
        if (!$valid) {
            ...
            foreach ($sheet as $x => $excel) {
                ...
                //Cek Duplikat User
                $duplikat_user  = $this->pengajar->cek_duplikat_user($excel['2']);

                if ($pengajar_id == 0 || $user != 1 || $duplikat_user != 0) {
                    $jumlaherror++;
                    ...
                    $log = [
                        ...
                        'waktu_log'    => date("H:i:s"),
                        'status_log'   => 'GAGAL',
                        'aktivitas_log'=> 'Edit Data Pengajar via Multiple Edit, Pengajar : ' .  $excel['5'] . ' ' . $gagal1 . $gagal2 . $gagal3,
                    ];
                    $this->log->insert($log);
                    //Data Log END
                } elseif($pengajar_id == 1 && $user == 1 && $duplikat_user == 0) {
